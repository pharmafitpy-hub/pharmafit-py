...
const CLIENT = {
  name:    'PharmaFit-Py',           // Nome curto, exibido em títulos e logo (fallback)
  ...
  ogImage: 'assets/img/og-image.png', // Imagem de preview em redes sociais (1200x630 ideal)
  baseUrl: '',                      // URL base do site, ex: 'https://meu-cliente.github.io/repo' (vazio = relativo)
};

const SHEETS_URL = '%%SHEETS_URL%%';
const WA_NUMBER  = '12142049853';       // alias retrocompatível
